...
HD_PWD='D:/Projects/fpga/calculator/calculator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log READER.vdi -applog -m64 -messageDb vivado.pb -mode batch -source READER.tcl -notrace
